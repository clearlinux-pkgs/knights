...
Version  : 19.12.0
Release  : 13
URL      : https://download.kde.org/stable/release-service/19.12.0/src/knights-19.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/knights-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/knights-19.12.0.tar.xz.sig
...
%prep
%setup -q -n knights-19.12.0
cd %{_builddir}/knights-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576557545
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knights-19.12.0/LICENSE %{buildroot}/usr/share/package-licenses/knights/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/knights-19.12.0/sounds/LICENSE %{buildroot}/usr/share/package-licenses/knights/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd clr-build
%make_install
popd
%find_lang knights
