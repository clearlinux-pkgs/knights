...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/knights-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/knights-24.12.0.tar.xz.sig
...
%setup -q -n knights-24.12.0
cd %{_builddir}/knights-24.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735346472
mkdir -p clr-build
pushd clr-build
